...
HyphyCommand <- "/root/miniconda3/bin/hyphy ./hyphy-analyses/LabelTrees/label-tree.bf --tree ./03_TranslatedGenomesOrthoFinder/OrthoFinder/Results_May31/Resolved_Gene_Trees/OG0015881_tree.txt --list TipsToObject.txt --output testtree.txt --internal-nodes \"None\""
